...
resultname=strcat('ILtestProbaRatSub',num2str(nsub),'Session',num2str(nsession));
...
for trial=1:totaltrial
    ...
    while GetSecs>0
        ...
        DrawFormattedText(Window,'|',xcenter+540,ycenter-15,[300 300 300]);
        DrawFormattedText(Window,'|',xcenter-6,ycenter-15,[300 300 300]);
        
        Screen('TextSize',Window,30);
       
        DrawFormattedText(Window,'0%',xcenter-545,ycenter+40,[300 300 300]);
        DrawFormattedText(Window,'100%',xcenter+515,ycenter+40,[300 300 300]);
        DrawFormattedText(Window,'50%',xcenter-20,ycenter+40,[300 300 300]);
