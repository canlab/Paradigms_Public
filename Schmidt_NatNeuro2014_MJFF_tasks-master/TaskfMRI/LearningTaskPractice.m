...
resultname=strcat('ILtestPracticeSub',num2str(nsub),'Session',num2str(nsession));
...
for n=1:length(pair)
    ...
    switch pair(n)
        ...
        case 1 % gain-associated pair (+£1)
            ...
            gainfeedbackRec=[xcenter-210 ycenter-110 xcenter+210 ycenter+110];
            lookfeedbackRec=[xcenter-210 ycenter-110 xcenter+210 ycenter+110];
        ...
        case 2 % loss pair (-£10)
            ...
            lossfeedbackRec=[xcenter-210 ycenter-110 xcenter+210 ycenter+110];
            lookfeedbackRec=[xcenter-210 ycenter-110 xcenter+210 ycenter+110];
...
times=[readytime starttrialloop endtrialloop];
...
scorewin=(sum(data(data(:,3)==1&data(:,8)==1)/32)*100);
scoreloss=(sum(data(data(:,3)==2&data(:,8)==1)/32)*100);
vectordata=[gainup; gain; lossup; loss].';
timedata=[starttrial' startfix' endfix' checktime1' endresp' startchoic' endchoic' checktime2' bonus' endfeed' endtrial'];
