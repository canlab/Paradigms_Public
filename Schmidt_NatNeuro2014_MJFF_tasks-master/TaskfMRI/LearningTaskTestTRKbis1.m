...
resultname=strcat('ILtestTRKSub',num2str(nsub),'Session',num2str(nsession));
...
for n=1:length(pair)
    ...
    switch pair(n)
        ...
        case 1 % gain-associated pair (+£1)
            ...
            if gainup(ngain)==1
                pairgainBRec=[xcenter-320 ycenter-120 xcenter-120 ycenter+120]; %left
                pairgainARec=[xcenter+120 ycenter-120 xcenter+320 ycenter+120]; %right
            else
                pairgainBRec=[xcenter+120 ycenter-120 xcenter+320 ycenter+120]; %right
                pairgainARec=[xcenter-320 ycenter-120 xcenter-120 ycenter+120]; %left
            end
            ...
            if choice(n)==0
                ...
                DrawFormattedText(Window,'^',xcenter+var*choice(n),ycenter+100,255);
                Screen('DrawTexture',Window,A,[],pairgainARec);
                Screen('DrawTexture',Window,B,[],pairgainBRec);
                startchoic(n)=Screen('Flip',Window);
                waitSecs(midjitter(n)+bonus(n))
            ...
            gainfeedbackRec=[xcenter-290 ycenter-180 xcenter+290 ycenter+180];
            lookfeedbackRec=[xcenter-290 ycenter-180 xcenter+290 ycenter+180];
        ...
        case 2 % loss pair (-£10)
            ...
            if lossup(nloss)==1
                pairlossBRec=[xcenter-320 ycenter-120 xcenter-120 ycenter+120]; %left
                pairlossARec=[xcenter+120 ycenter-120 xcenter+320 ycenter+120]; %right
            else
                pairlossBRec=[xcenter+120 ycenter-120 xcenter+320 ycenter+120]; %right
                pairlossARec=[xcenter-320 ycenter-120 xcenter-120 ycenter+120]; %left
            end
            ...
            lossfeedbackRec=[xcenter-290 ycenter-180 xcenter+290 ycenter+180];
            lookfeedbackRec=[xcenter-290 ycenter-180 xcenter+290 ycenter+180];
