...
resultname=strcat('ILtestPrefRatSub',num2str(nsub),'Session',num2str(nsession));
...
for trial=1:totaltrial
    ...
    while GetSecs>0
        ...
        DrawFormattedText(Window,'|',xcenter+540,ycenter-15,[300 300 300]);
        DrawFormattedText(Window,'|',xcenter-270,ycenter-15,[300 300 300]);
        DrawFormattedText(Window,'|',xcenter+270,ycenter-15,[300 300 300]);
        Screen('TextSize',Window,30);
        DrawFormattedText(Window,'most liked',xcenter-610,ycenter-50,[300 300 300]);
        DrawFormattedText(Window,'least liked',xcenter+475,ycenter-50,[300 300 300]);
        DrawFormattedText(Window,'1',xcenter-545,ycenter+40,[300 300 300]);
        DrawFormattedText(Window,'4',xcenter+535,ycenter+40,[300 300 300]);
        DrawFormattedText(Window,'2',xcenter-275,ycenter+40,[300 300 300]);
        DrawFormattedText(Window,'3',xcenter+265,ycenter+40,[300 300 300]);
        xOffset = xshift;
        yOffset = yshift;
