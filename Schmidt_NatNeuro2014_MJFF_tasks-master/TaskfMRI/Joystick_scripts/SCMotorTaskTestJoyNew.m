...
resultname=strcat('MtaskTestJoyNewSub',num2str(nsub),'Session',num2str(nsession));
...
% motionParam=2;
motionThresh=0.12; % minimum argument coming from the joystick (allows it to remain stationary)
speed=60;
...
for trial=1:160
    ...
    if stimlist(trial)==0
        ...
        mycolors(2,sample(n,3:4))=55; %blue ovals      
