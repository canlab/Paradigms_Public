function [ts, exp, post_q] = generate_ts_pain_cond_ctrl
...
n_stim = 8;
idx = ones(1,n_stim) + [6 6 6 6 7 7 7 7]; %enforce equal numbers of elem by permuting idx
